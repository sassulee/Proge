...
class SecondPage(Frame):
    def __init__(self, parent, controller):
        ...
        Label(self, text="Milline söögikord on?", font=("Arial", 30), bg="#d0edf7").place(relx=0.5, rely=0.25, anchor=CENTER)
        y = 0.45
...
class ThirdPage(Frame):
    def __init__(self, parent, controller):
        ...
        Label(self, text="Mis on sinu eesmärk?", font=("Arial", 30), bg="#d0edf7").place(relx=0.5, rely=0.25, anchor=CENTER)
        y = 0.45
...
class FourthPage(Frame):
    def __init__(self, parent, controller):
        ...
        Label(self, text="Mis sorti sööki soovid?", font=("Arial", 30), bg="#d0edf7").place(relx=0.5, rely=0.25, anchor=CENTER)
        y = 0.45
...
class FoodListPage(Frame):
    def __init__(self, parent, controller):
        ...
        Label(self, text="Vali söök", font=("Arial", 28), bg="#d0edf7").place(relx=0.5, rely=0.1, anchor=CENTER)

        self.buttons = []

        Button(self, text="Tagasi algusesse", command=lambda: controller.show_frame("StartPage"),
               width=20, height=2).place(relx=0.5, rely=0.9, anchor=CENTER)
    ...
    def update_foods(self):
        ...
        for food, recipe in foods.items():
            btn = Button(self, text=food, width=25, height=2,
                         command=lambda f=food, r=recipe: self.open_recipe(f, r))
...
class RecipePage(Frame):
    def __init__(self, parent, controller):
        ...
        Button(self, text="Tagasi toitude juurde", command=lambda: controller.show_frame("FoodListPage"),
               width=20, height=2).place(relx=0.5, rely=0.85, anchor=CENTER)
