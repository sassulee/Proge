...
class StartPage(Frame):
    def __init__(self, parent, controller):
        ...
        Button(self, text="Start", command=lambda: controller.show_frame("SecondPage"),
               width=15, height=2).place(relx=0.5, rely=0.5, anchor=CENTER)
...
class SecondPage(Frame):
    def __init__(self, parent, controller):
        ...
        Label(self, text="Milline söögikord on?", font=("Arial", 40), bg="#d0edf7").place(relx=0.5, rely=0.3, anchor=CENTER)
        
        y=0.5
        
        Button(self, text="Hommikusöök", command=lambda: controller.show_frame("ThirdPage"),
               width=25, height=2).place(relx=0.5, rely=y, anchor=CENTER)
        y += 0.15  
        
        Button(self, text="Lõunasöök", command=lambda: controller.show_frame("ThirdPage"),
               width=25, height=2).place(relx=0.5, rely=y, anchor=CENTER)
        y += 0.15
        
        Button(self, text="Õhtusöök", command=lambda: controller.show_frame("ThirdPage"),
               width=25, height=2).place(relx=0.5, rely=y, anchor=CENTER)
...
class ThirdPage(Frame):
    def __init__(self, parent, controller):
        ...
        Label(self, text="Mis on sinu eesmärk?", font=("Arial", 40), bg="#d0edf7").place(relx=0.5, rely=0.3, anchor=CENTER)
        
        y=0.5
        
        Button(self, text="Võtta kaalust alla", command=lambda: controller.show_frame("FourthPage"),
               width=25, height=2).place(relx=0.5, rely=y, anchor=CENTER)
        y += 0.15  
        
        Button(self, text="Võtta kaalust juurde", command=lambda: controller.show_frame("FourthPage"),
               width=25, height=2).place(relx=0.5, rely=y, anchor=CENTER)
        y += 0.15
        
        Button(self, text="Säilitada kaalu", command=lambda: controller.show_frame("FourthPage"),
               width=25, height=2).place(relx=0.5, rely=y, anchor=CENTER)
...
class FourthPage(Frame):
    def __init__(self, parent, controller):
        ...
        Label(self, text="Mis sorti sööki soovid?", font=("Arial", 40), bg="#d0edf7").place(relx=0.5, rely=0.3, anchor=CENTER)
        y=0.5
        
        Button(self, text="Magus", command=lambda: controller.show_frame("FoodListPage"),
               width=25, height=2).place(relx=0.5, rely=y, anchor=CENTER)
        y += 0.15  
        
        Button(self, text="Soolane", command=lambda: controller.show_frame("FoodListPage"),
               width=25, height=2).place(relx=0.5, rely=y, anchor=CENTER)
        y += 0.15
